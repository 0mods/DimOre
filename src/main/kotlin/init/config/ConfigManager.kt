...
object ConfigManager {
    ...
    inline fun <reified T : Any> saveOrLoad(file: File, defaults: T): T =
        saveOrLoad(file, defaults, serializer())
    ...
    inline fun <reified T : Any> regenerate(
        cache: MutableMap<String, Any>,
        file: File,
        config: T,
        defaults: T
    ...
    private fun <T : Any> recoverBrokenConfig(
        file: File,
        defaults: T,
        serializer: KSerializer<T>,
        cause: Exception
    ...
    fun injectComments(
        ...
        currentRoot: JsonElement,
        defaultsRoot: JsonElement
    ): String {
            ...
            try {
                for (index in 0 until descriptor.elementsCount) {
                    ...
                    if (currentValue != null && defaultValue != null) {
                        ...
                        visit(childDescriptor, currentValue, defaultValue, path, inheritedChildPolicy)
                    }
                }
            } finally {
                recursionStack.remove(descriptor.serialName)
